        ...
        <div x-show="isOpen"
            ...
            <div class="relative">
                <div class="absolute h-full right-5 flex items-center">
                    <svg class="animate-spin h-5 w-5 text-gray-700 dark:text-white"
                ...
                <input
                    ...
                    class="
                        appearance-none w-full px-6 py-4 text-lg outline-none

                        bg-transparent
                        placeholder-gray-400 text-gray-900     <!-- MODO CLARO -->
                        dark:text-gray-300 dark:placeholder-gray-500  <!-- MODO OSCURO -->
                    "
                    ...
                    <template x-for="(item, i) in filteredItems()" :key>
                        <li>
                            <button
                                ...
                                :class="{
                                    'bg-gray-200 dark:bg-gray-700': selected === i,
                                    'hover:bg-gray-100 dark:hover:bg-gray-800': selected !== i
                                }"
                            >
                                <span x-text="item[0].item.name"
                                      :class="{
                                          'text-gray-900 dark:text-gray-300': selected !== i,
                                          'text-black dark:text-white': selected === i
                                      }"></span>

                                <span x-text="item[0].item.description"
                                      class="ml-1"
                                      :class="{
                                          'text-gray-500 dark:text-gray-500': selected !== i,
                                          'text-gray-700 dark:text-gray-400': selected === i
                                      }"></span>
                            </button>
                        </li>
                    </template>
